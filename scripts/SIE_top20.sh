...
python main.py --experience SIE --exp-dir results/baseline --root-log-dir results/logs/ --epochs 2324 --arch resnet18 --equi 256 --batch-size 1024 --base-lr 1e-3 --dataset-root /home/araymond/storage/investigacion/datasets/3DIEBench --images-file ./data/samples_top20.npy --labels-file ./data/labels_top20.npy --sim-coeff 10 --std-coeff 10 --cov-coeff 1 --mlp 2048-2048-2048 --equi-factor 0.45 --hypernetwork linear
